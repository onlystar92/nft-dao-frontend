        ...
        >
            <h3 className="mc__title">
                {status === "success" ? "Success!" :
                    "Join to our email list for future updates."}
            </h3>
            ...
            {status !== "success" ? (
                <div className="mc__field-container">
                    ...
                    {/* <p className="description"> You can unsubscribe your email at any time.</p> */}
                </div>
            ) : null}
...
const MailchimpForm = props => {
    const url = `https://gmail.us20.list-manage.com/subscribe/post?u=a11faf44f98f5464e76446110&id=ac93c24713`;
    //const url = `https://genhybridsystems.us1.list-manage.com/subscribe/post?u=aa512b4987d35da69f0fc6717&id=92f53d9f93`;
